...
export const actions = {
  ...
  setSearchInputValue: (payload: string) => ({
    type: 'setSearchInputValue',
    payload,
  }),
  setIsSearchPending: (payload: boolean) => ({
    type: 'setIsSearchPending',
    payload,
  }),
  setIsLoginPending: (payload: boolean) => ({
    type: 'setIsLoginPending',
    payload,
  }),
  setIsLogoutPending: (payload: boolean) => ({
    type: 'setIsLogoutPending',
    payload,
  }),
  ...
  setLoginStatus: (payload: facebookSdk.LoginStatus | undefined) => ({
    type: 'setLoginStatus',
    payload,
  }),
  setError: (payload: HvError) => ({ type: 'setError', payload }),
  setIsNavMenuOpen: (payload: boolean) => ({
    type: 'setIsNavMenuOpen',
    payload,
  }),
  setLastSearchTerm: (payload: string) => ({
    type: 'setLastSearchTerm',
    payload,
  }),
  ...
  requestSearchResults: (payload: string) => ({
  ...
  requestNotablePerson: (payload: string) => ({
    type: 'requestNotablePerson',
    payload,
  }),
...
export const ActionTypes = stringEnum(Object.keys(actions)) as {
  [name in ActionTypes]: ActionTypes
};
